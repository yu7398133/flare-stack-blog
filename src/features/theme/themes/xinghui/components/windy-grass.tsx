...
export function WindyGrass() {
  ...
  useEffect(() => {
    const generated: GrassBlade[] = Array.from({ length: 150 }).map((_, i) => ({
      id: i,
      ...
      {blades.map((blade) => (
        <div
          ...
          style={{
            ...
            animation: `xh-swayGrass ${blade.duration}s ease-in-out infinite alternate`,
